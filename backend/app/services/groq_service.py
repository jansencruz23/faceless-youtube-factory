...
class GroqService:
    ...
    async def generate_script(self, topic: str) -> Dict[str, Any]:
        ...
        prompt = ChatPromptTemplate.from_messages(
            ...
            Follow these rules:
            1. Use distinct speakers if necessary (e.g., specific names or generic 'Narrator'). Follow the user's instructions.
            ...
            {{
                "scenes": [
                    {{
                        "speaker": "Narrator",
                        "line": "I have always been fascinated by the power of AI.",
                        "duration": 3.0
                    }}
                ]
            }}
    ...
    async def generate_metadata(
        self, script_content: str, context: Optional[str] = None
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            result = await chain.ainvoke(
                {"script": script_text[:8000], "context": context or "None"}
            )
            return result
        except Exception as e:
